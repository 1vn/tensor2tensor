...
do
  ...
  --model=transformer \
  --hparams_set=$h \
  --worker_gpu=0 --use_tpu=True --cloud_tpu_name=$2  --decode_to_file="gs://for-ai/runs/a1vn/$o/prune_$i/translation.en" --decode_hparams="beam_size=$BEAM_SIZE,alpha=$ALPHA" \
